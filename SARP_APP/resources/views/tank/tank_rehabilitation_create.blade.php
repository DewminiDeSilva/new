...
<div class="row">
  ...
  <select id="provinceDropdown" name="province" button class="btn btn-success dropdown-toggle" required>
  ...
  <select id="districtDropdown" name="district" button class="btn btn-success dropdown-toggle" required>
  ...
  <select id="dsDivisionDropdown" name="ds_division" button class="btn btn-success dropdown-toggle"required>
  ...
  <select id="gndDropdown" name="gn_division" button class="btn btn-success dropdown-toggle" required>
  ...
  <select id="ascDropdown" name="as_centre" button class="btn btn-success dropdown-toggle" required>
  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <div class="dropdown">
        ...
        <select class="form-control btn btn-success"  name="progress" data-bs-toggle="dropdown" aria-expanded="false" required>
